...
export const mockVacationRequests: VacationRequest[] = [
    ...
    statusHistory: [
      {
        ...
        changedAt: '2024-12-01T10:00:00',
        changedBy: '1',
        changedByName: 'Иванов Иван Иванович',
      },
      {
        status: VacationRequestStatus.APPROVED,
        changedAt: '2024-12-05T14:30:00',
        changedBy: '2',
  ...
  },
  {
    ...
    statusHistory: [
      {
        status: VacationRequestStatus.ON_APPROVAL,
        changedAt: '2024-12-15T10:00:00',
        changedBy: '2',
        changedByName: 'Петров Петр Петрович',
      },
      {
        status: VacationRequestStatus.APPROVED,
        changedAt: '2024-12-20T14:30:00',
        changedBy: '3',
  ...
  },
  {
    ...
    statusHistory: [
      {
        status: VacationRequestStatus.ON_APPROVAL,
        changedAt: '2025-01-08T10:00:00',
        changedBy: '4',
        changedByName: 'Иванова Анна Сергеевна',
      },
      {
        status: VacationRequestStatus.APPROVED,
        changedAt: '2025-01-10T14:30:00',
        changedBy: '2',
        changedByName: 'Петров Петр Петрович',
        comment: 'Согласовано',
      },
  ...
  },
  {
    ...
    statusHistory: [
      {
        status: VacationRequestStatus.ON_APPROVAL,
        changedAt: '2025-01-12T10:00:00',
        changedBy: '4',
        changedByName: 'Иванова Анна Сергеевна',
      },
      {
        status: VacationRequestStatus.APPROVED,
        changedAt: '2025-01-14T14:30:00',
        changedBy: '2',
        changedByName: 'Петров Петр Петрович',
        comment: 'Согласовано',
      },
  ...
  },
  {
    ...
    statusHistory: [
      {
        status: VacationRequestStatus.ON_APPROVAL,
        changedAt: '2025-01-03T10:00:00',
        changedBy: '5',
        changedByName: 'Петрова Мария Александровна',
      },
      {
        status: VacationRequestStatus.APPROVED,
        changedAt: '2025-01-05T14:30:00',
        changedBy: '2',
        changedByName: 'Петров Петр Петрович',
        comment: 'Согласовано',
      },
...
export const mockVacationBalances: Record<string, VacationBalance> = {
  '1': {
    ...
    travelNextAvailableDate: '2025-06-01',
    hireDate: '2020-03-01',
  },
  '2': {
    userId: '2',
    ...
    travelNextAvailableDate: '2024-08-15',
    hireDate: '2018-01-15',
  },
  '3': {
    userId: '3',
    ...
    travelNextAvailableDate: '2025-09-01',
    hireDate: '2021-06-01',
  },
  '4': {
    userId: '4',
  ...
  '5': {
    ...
    travelNextAvailableDate: '2025-05-01',
    hireDate: '2020-08-20',
  },
}
