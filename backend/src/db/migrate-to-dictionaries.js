...
async function runMigrations() {
  console.log('Starting migration: update tables to use dictionaries...')
  ...
  try {
    ...
    await db.query(`CREATE INDEX idx_vacation_requests_status_id ON vacation_requests(status_id)`)
    console.log('  ✓ recreated index for status_id')

    console.log('Step 10: Update views or functions if needed...')

    console.log('Step 11: Verify data integrity...')
    ...
    console.log('\nMigration summary:')
    console.log('  - Created dictionaries: request_statuses, vacation_types')
    ...
    console.log('  2. Optionally drop old ENUM types: request_status_enum, vacation_type_enum')
